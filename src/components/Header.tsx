...
import ShoppingIcon from "../assets/shopping-cart.png"; // Ícone
        ...
        <nav>
          <ul className="nav">
            <li className="nav-item">
              <Link to="/criar-lista" className="nav-link text-white">
                Criar Lista
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/consultar" className="nav-link text-white">
                Consultar Lista
              </Link>
            </li>
            <li className="nav-item">
